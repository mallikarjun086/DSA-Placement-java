...
Pattern: Dynamic Programming (0/1 Knapsack Transformation)
Difficulty: Medium

Approach:
- Convert problem to subset sum:
  Let total sum = S
  We need subset with sum = (S + target) / 2
- Use DP to count number of subsets with given sum
- Classic 0/1 Knapsack count variation
